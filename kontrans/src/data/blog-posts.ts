...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: 'Откријте како најновите технолошки достигнувања го трансформираат светот на логистиката и транспортот.',
    content: `
    ...
    date: '2023-07-15',
    imageUrl: '/blog-tech-logistics.jpg'
  },
  {
    id: '2',
    title: 'Одржлив транспорт: Зелената револуција во логистиката',
    excerpt: 'Истражете како логистичката индустрија се движи кон поодржливи практики за намалување на влијанието врз животната средина.',
    content: `
    ...
    date: '2023-07-22',
    imageUrl: '/blog-green-logistics.jpg'
  },
  {
    id: '3',
    title: 'Предизвици и можности во глобалниот синџир на снабдување',
    excerpt: 'Анализа на тековните предизвици во глобалниот синџир на снабдување и стратегии за нивно надминување.',
    content: `
